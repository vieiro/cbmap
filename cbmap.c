...
void* cbmap_default_allocator(void* data, size_t data_len)
{
...
void cbmap_default_deallocator(void* data)
{
	CBM_FREE(data);
}
...
void* cbmap_nop_allocator(void* data, size_t data_len)
{
	return data;
}

void cbmap_nop_deallocator(void* data)
{
	; /* Empty */
}
...
struct cbmap_data_node* cbmap_data_node_new(cbmap_allocator_t key_allocator, cbmap_allocator_t value_allocator,
...
void* cbmap_data_node_update_value(cbmap_allocator_t value_allocator, struct cbmap_data_node* data, void* value, size_t value_len)
{
...
cbmap_t cbmap_new_with_custom_allocation(cbmap_allocator_fn key_allocator, cbmap_deallocator_fn key_deallocator,
					 cbmap_allocator_fn value_allocator, cbmap_deallocator_fn value_deallocator)
{
...
{
	return cbmap_new_with_custom_allocation(CBMAP_DEFAULT_ALLOCATOR.malloc, CBMAP_DEFAULT_ALLOCATOR.free,
						CBMAP_DEFAULT_ALLOCATOR.malloc, CBMAP_DEFAULT_ALLOCATOR.free);
}

cbmap_t cbmap_new_with_static_keys_and_values(void)
{
	return cbmap_new_with_custom_allocation(CBMAP_NOP_ALLOCATOR.malloc, CBMAP_NOP_ALLOCATOR.free,
						CBMAP_NOP_ALLOCATOR.malloc, CBMAP_NOP_ALLOCATOR.free);
}

#pragma mark - cbmap_destroy

void cbmap_recursive_delete(void* top, cbmap_allocator_t key_allocator, cbmap_allocator_t value_allocator)
{
